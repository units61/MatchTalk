"use strict";
(self["webpackChunkmatchtalk_web"] = self["webpackChunkmatchtalk_web"] || []).push([[644],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  C5: () => (/* reexport */ Navigate),
  qh: () => (/* reexport */ Route),
  BV: () => (/* reexport */ Routes),
  Zp: () => (/* reexport */ dist_useNavigate),
  g: () => (/* reexport */ useParams)
});

// UNUSED EXPORTS: AbortedDeferredError, Await, Form, HashRouter, Link, MemoryRouter, NavLink, NavigationType, Outlet, Router, RouterProvider, ScrollRestoration, UNSAFE_DataRouterContext, UNSAFE_DataRouterStateContext, UNSAFE_ErrorResponseImpl, UNSAFE_FetchersContext, UNSAFE_LocationContext, UNSAFE_NavigationContext, UNSAFE_RouteContext, UNSAFE_ViewTransitionContext, UNSAFE_useRouteId, UNSAFE_useScrollRestoration, createBrowserRouter, createHashRouter, createMemoryRouter, createPath, createRoutesFromChildren, createRoutesFromElements, createSearchParams, defer, generatePath, isRouteErrorResponse, json, matchPath, matchRoutes, parsePath, redirect, redirectDocument, renderMatches, replace, resolvePath, unstable_HistoryRouter, unstable_usePrompt, useActionData, useAsyncError, useAsyncValue, useBeforeUnload, useBlocker, useFetcher, useFetchers, useFormAction, useHref, useInRouterContext, useLinkClickHandler, useLoaderData, useLocation, useMatch, useMatches, useNavigation, useNavigationType, useOutlet, useOutletContext, useResolvedPath, useRevalidator, useRouteError, useRouteLoaderData, useRoutes, useSearchParams, useSubmit, useViewTransitionState
...
function dist_useLocation() {
  !useInRouterContext() ?  false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) : void 0;
...
function useNavigateUnstable() {
  ...
  let routePathnamesJson = JSON.stringify((0,router/* UNSAFE_getResolveToMatches */.yD)(matches, future.v7_relativeSplatPath));
  ...
  let navigate = react.useCallback(function (to, options) {
    ...
    let path = (0,router/* resolveTo */.Gh)(to, JSON.parse(routePathnamesJson), locationPathname, options.relative === "path");
    ...
    if (dataRouterContext == null && basename !== "/") {
      path.pathname = path.pathname === "/" ? basename : (0,router/* joinPaths */.HS)([basename, path.pathname]);
    }
...
{}
  ...
  if (locationArg) {
    ...
    let parsedLocationArg = typeof locationArg === "string" ? (0,router/* parsePath */.Rr)(locationArg) : locationArg;
    !(parentPathnameBase === "/" || ((_parsedLocationArg$pa = parsedLocationArg.pathname) == null ? void 0 : _parsedLocationArg$pa.startsWith(parentPathnameBase))) ?  false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) : void 0;
  ...
  let matches = (0,router/* matchRoutes */.ue)(routes, {
...
{}
  let renderedMatches = _renderMatches(matches && matches.map(match => Object.assign({}, match, {
    ...
    pathname: (0,router/* joinPaths */.HS)([parentPathnameBase,
    // Re-encode pathnames that were decoded inside matchRoutes
    navigator.encodeLocation ? navigator.encodeLocation(match.pathname).pathname : match.pathname]),
    pathnameBase: match.pathnameBase === "/" ? parentPathnameBase : (0,router/* joinPaths */.HS)([parentPathnameBase,
    // Re-encode pathnames that were decoded inside matchRoutes
  ...
  if (locationArg && renderedMatches) {
    return /*#__PURE__*/react.createElement(LocationContext.Provider, {
      value: {
        ...
        navigationType: router/* Action */.rc.Pop
      }
    }, renderedMatches);
  }
...
function DefaultErrorComponent() {
  ...
  let message = (0,router/* isRouteErrorResponse */.pX)(error) ? error.status + " " + error.statusText : error instanceof Error ? error.message : JSON.stringify(error);
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  if (errors != null) {
    ...
    !(errorIndex >= 0) ?  false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) : void 0;
...
function useDataRouterState(hookName) {
  ...
  !state ?  false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) : void 0;
  return state;
}
function useRouteContext(hookName) {
  let route = react.useContext(RouteContext);
  !route ?  false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) : void 0;
  return route;
}
...
function useCurrentRouteId(hookName) {
  ...
  !thisRoute.route.id ?  false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) : void 0;
...
function Navigate(_ref4) {
  ...
  let path = (0,router/* resolveTo */.Gh)(to, (0,router/* UNSAFE_getResolveToMatches */.yD)(matches, future.v7_relativeSplatPath), locationPathname, relative === "path");
...
function Route(_props) {
   false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) ;
}
/**
...
function dist_Router(_ref5) {
  ...
  if (typeof locationProp === "string") {
    locationProp = (0,router/* parsePath */.Rr)(locationProp);
  }
  let {
    pathname = "/",
    search = "",
  ...
  let locationContext = react.useMemo(() => {
    let trailingPathname = (0,router/* stripBasename */.pb)(pathname, basename);
...
class AwaitErrorBoundary extends react.Component {
  ...
  render() {
    ...
    if (status === AwaitRenderStatus.error && promise._error instanceof router/* AbortedDeferredError */.tH) {
...
function createRoutesFromChildren(children, parentPath) {
  ...
  react.Children.forEach(children, (element, index) => {
    ...
    !(element.type === Route) ?  false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) : void 0;
    !(!element.props.index || !element.props.children) ?  false ? 0 : (0,router/* UNSAFE_invariant */.Oi)(false) : void 0;
    let route = {
...
function BrowserRouter(_ref4) {
  ...
  let historyRef = react.useRef();
  if (historyRef.current == null) {
    historyRef.current = (0,router/* createBrowserHistory */.zR)({
      window,
      v5Compat: true
    });
  }
...
const Link = /*#__PURE__*/(/* unused pure expression or super */ null && (React.forwardRef(function LinkWithRef(_ref7, ref) {
  ...
  return (
    ...
    React.createElement("a", dist_extends({}, rest, {
...
const NavLink = /*#__PURE__*/(/* unused pure expression or super */ null && (React.forwardRef(function NavLinkWithRef(_ref8, ref) {
  ...
  return /*#__PURE__*/React.createElement(Link, dist_extends({}, rest, {
...
const Form = /*#__PURE__*/(/* unused pure expression or super */ null && (React.forwardRef((_ref9, forwardedRef) => {
  ...
  return /*#__PURE__*/React.createElement("form", dist_extends({
    ref: forwardedRef,
    method: formMethod,
    action: formAction,
...
function useFormAction(action, _temp2) {
  ...
  let path = dist_extends({}, useResolvedPath(action ? action : ".", {
    relative
  }));
...
function useFetcher(_temp3) {
  ...
  let submit = React.useCallback((target, opts) => {
    submitImpl(target, dist_extends({}, opts, {
      navigate: false,
      fetcherKey
    }));
  ...
  let FetcherForm = React.useMemo(() => {
    let FetcherForm = /*#__PURE__*/React.forwardRef((props, ref) => {
      return /*#__PURE__*/React.createElement(Form, dist_extends({}, props, {
        navigate: false,
...
{}
  ...
  let fetcherWithComponents = React.useMemo(() => dist_extends({
    Form: FetcherForm,
    submit,
    load
  }, fetcher, {
